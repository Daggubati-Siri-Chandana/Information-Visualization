...
def build_leaf(name, leaf):
    ...
    """
    if(len(name)==2 and name[1].isnumeric()):
        res = {"name": name[0], "size":name[1]}
    else:
        res = {"name": name}
...
def main():
    ...
    with open('/Users/daggubatisirichandana/PycharmProjects/chart_percept/A3files/crops.csv') as csvfile:
    ...
    import json
    file1 = open("/Users/daggubatisirichandana/PycharmProjects/chart_percept/A3files/scrops.json","w")
    file1.write(json.dumps(res[0]))
    file1.close()
